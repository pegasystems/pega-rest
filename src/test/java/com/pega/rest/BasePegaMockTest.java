...
/**
 * Base class for all Pega mock tests.
 */
public class BasePegaMockTest {
     ...
     * @return instance of PegaApi.
     */
    public PegaApi api(final URL url) {
        final PegaAuthentication creds = PegaAuthentication
                .builder()
                .credentials("hello:world")
                .build();
        final PegaAuthenticationModule credsModule = new PegaAuthenticationModule(creds);
