...
public abstract class AgentInfo {
    ...
    @SerializedNames({ "agent_id", "instances" })
    public static AgentInfo create(final String agentId,
                                   final List<Instance> instances) {

        return new AutoValue_AgentInfo(agentId, PegaUtils.nullToEmpty(instances));
    }
}
