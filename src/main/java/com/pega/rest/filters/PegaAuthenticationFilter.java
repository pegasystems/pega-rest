...
@Singleton
public class PegaAuthenticationFilter implements HttpRequestFilter {
    private final PegaAuthentication creds;

    @Inject
    PegaAuthenticationFilter(final PegaAuthentication creds) {
        this.creds = creds;
    }
