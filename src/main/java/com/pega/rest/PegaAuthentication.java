...
/**
 * Credentials instance for Pega authentication.
 */
public class PegaAuthentication extends Credentials {

    private final AuthenticationType authType;

    /**
     * Create instance of PegaAuthentication
     * 
     ...
     */
    private PegaAuthentication(final String authValue, final AuthenticationType authType) {
    ...
    public static class Builder {
        ...
        /**
         * Build and instance of PegaAuthentication.
         * 
         * @return instance of PegaAuthentication.
         */
        public PegaAuthentication build() {
            return new PegaAuthentication(authValue, authType != null
                    ? authType
